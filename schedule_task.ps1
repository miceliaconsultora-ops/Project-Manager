...
# 2. Definir el disparador (Diariamente a las 02:00)
...
try {
    Register-ScheduledTask -TaskName $TaskName -Action $Action -Trigger $Trigger -Settings $Settings -Description "Sincroniza automáticamente el Dashboard de Project Manager y sube cambios a GitHub diariamente a las 02:00." -Force | Out-Null
    ...
    Write-Host "  Hora: Todos los días a las 02:00 (2:00 AM)" -ForegroundColor Gray
